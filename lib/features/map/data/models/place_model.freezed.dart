...
class _$PlaceModelImpl implements _PlaceModel {
  ...
  @override
  String toString() {
    return 'PlaceModel(id: $id, name: $name, address: $address, latitude: $latitude, longitude: $longitude, category: $category, rating: $rating)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, address, latitude, longitude, category, rating);
...
abstract class _PlaceModel implements PlaceModel {
  const factory _PlaceModel(
      ...
      final String? category,
      final double? rating}) = _$PlaceModelImpl;
